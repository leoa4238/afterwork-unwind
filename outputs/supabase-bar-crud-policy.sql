-- Enable authenticated users to manage bar data for the submitted admin demo.
-- Run in Supabase Dashboard > SQL Editor when /admin bar CRUD shows an RLS error.

GRANT INSERT, UPDATE, DELETE ON public.bars TO authenticated;
GRANT INSERT, UPDATE, DELETE ON public.bar_tags TO authenticated;
